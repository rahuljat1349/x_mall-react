  ...
  return (
    <>
      <div className="w-[100vw] py-8 flex justify-center">
        <div className="sm:w-[70%] sm:p-8 p-2 mt-12 justify-between flex flex-col h-[45vh] w-[60%] md:h-[60vh] sm:h-[50vh] lg:w-[60%] shadow-2xl rounded-3xl">
          ...
          <div className=" h-full text-center py-4 px-8 items-center justify-between flex-col flex">
            ...
            <div className="flex gap-14">
              <div className="flex flex-col">
                <span className="text-xl font-semibold text-gray-500">28</span>
                <span className="font-semibold text-gray-800">Orders</span>
              </div>
              <div className="flex flex-col">
                <span className="text-xl font-semibold text-gray-500">16</span>
